...
const SupportRecoveryButton = (props) =>{
    const {owner} = props;
    const {account} = props;
    ...
    const supportRecovery = async(e) => {
        ...
        contractList.methods.supportRecovery(sendData.newOwner).send({from: account})
    ...
    return(
        <Col>
            ...
            <Modal
                ...
                centered>
            <Modal.Header>
                <Modal.Title> 覆議恢復流程 </Modal.Title>
            </Modal.Header>
                <Modal.Body>
                    <form onSubmit={supportRecovery}>
...
export default SupportRecoveryButton;